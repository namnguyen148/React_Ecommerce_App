...
export default function ProductAddModal({
  ...
  const handleFileSelect = (event) => {
    ...
    if (!selectedFile) {
      ...
      setIsError(true);
      setErrorMsg("File size lớn hơn 2MB.");
    } else {
      setIsError(false);
      setErrorMsg("");
    }
        ...
        <Formik
          ...
          onSubmit={(values) => {
            ...
            setTimeout(async () => {
              ...
              try {
                if (values.product_image == null) {
                  await axios.post("products/add", values);
                } else {
                ...
                if (error.response && error.response.data) {
                  const errorMessage =
                    error.response.data.errors.product_image[0]
                ...
                <Col className="text-center">
                  <Form.Group className="mb-3" controlId="validationFormik05">
                    ...
                    {image ? (
                      ...
                      <Image
                        className="figure-img img-fluid img-thumbnail"
                        src="https://i.pinimg.com/originals/7c/af/80/7caf801a71759db31babb2a8c2d5f83a.jpg"
                        style={{ height: "290px" }}
                        rounded
                      />
                    )}
